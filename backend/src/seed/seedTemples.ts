// One-off dev seed script: migrates the 22 hardcoded temples from
// /src/data/templeData.ts (frontend, read-only source of truth for this data)
// into the Place collection as approved documents, with English translations added.
//
...
const temples: SeedTemple[] = [
  ...
  },
  {
    ...
    importanceEnglish:
      "Part of the twelve Madhav pilgrimage circuit, described in the Puranas.",
    visitingHours: "सुबह 6 बजे से रात 8 बजे तक",
    visitingHoursEnglish: "6:00 AM to 8:00 PM",
  ...
  },
  {
    ...
    importanceEnglish:
      "Also counted as the 12th temple in the mythological pilgrimage circuit.",
    visitingHours: "सुबह 6–8 बजे, शाम 4–6 बजे",
    visitingHoursEnglish: "6:00–8:00 AM, 4:00–6:00 PM",
...
async function seed() {
  ...
  const docs = temples.map((temple) => ({
    name: temple.name,
    nameHindi: temple.nameHindi,
    category: "Temple" as const,
    location: temple.location,
    locationEnglish: temple.locationEnglish,
    descriptionHindi: temple.descriptionHindi,
    descriptionEnglish: temple.descriptionEnglish,
    visitingHours: temple.visitingHours,
    visitingHoursEnglish: temple.visitingHoursEnglish,
    importance: temple.importance,
    importanceEnglish: temple.importanceEnglish,
    specialFeatures: temple.specialFeatures,
    specialFeaturesEnglish: temple.specialFeaturesEnglish,
  ...
  console.log(`Seeded ${docs.length} temples as approved places.`);
