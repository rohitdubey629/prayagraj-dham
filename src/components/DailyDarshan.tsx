  ...
  return (
    <section className="py-12 bg-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-bhagwa-dark mb-2 text-center font-serif">दैनिक दर्शन कार्यक्रम</h2>
        <div className="w-24 h-1 bg-bhagwa-dark mx-auto mb-8"></div>
        
        <div className="max-w-2xl mx-auto bg-amber-50 rounded-lg p-6 shadow-md">
          <div className="space-y-4">
            {darshans.map((item, index) => (
              <div key={index} className="flex items-start">
                ...
                <div>
                  <h3 className="font-bold text-bhagwa-dark">{item.event}</h3>
          ...
          <div className="mt-6 text-center">
            <Link href="/darshan-schedule" className="inline-flex items-center text-bhagwa-dark font-medium hover:underline">
