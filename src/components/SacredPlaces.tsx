  ...
  return (
    <section className="py-12 bg-amber-50">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-bhagwa-dark mb-2 text-center font-serif">प्रयागराज के पावन स्थल</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {sacredSites.map((site, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition">
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold text-bhagwa-dark mb-2 font-serif">{site.name}</h3>
                <p className="text-gray-600 mb-4">{site.description}</p>
                <Link href={site.link} className="text-bhagwa-dark font-medium hover:underline flex items-center">
